#### time_seriesv2.py
#### Genera series de tiempo y un archivo hdf con todos los datos filtrados
...
path_plotout = "f:\\CCA\\NASAGESDISC\\mexico\\"
...
### INICIA prueba de seleccion de grids en la matriz 9x9 de grids aledanyos al punto de interes
...
#    print(gridname)
### TERMINA prueba de seleccion de grids en la matriz 9x9 de grids aledanyos al punto de interes
...
# Creacion del archivo HDF de salida con los datos filtrados
